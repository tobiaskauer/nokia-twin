...
export default {
  ...
  /*  bus.$on('getit', function(parameter) { //listen on EventBus for changed queries
 ...
 methods: {
   ...
   drawLines: function() {
     ...
     d3.select("#vis svg").append("g").attr("class","lines").selectAll("path").data(this.results).enter()
